...
import com.huangyiming.disjob.common.exception.EjobFrameWorkException;
...
import com.huangyiming.disjob.register.domain.EjobServerInfo;
...
//    		job.setSlaveIp(slaveIp);
    ...
    public int averageDistributeSlaveJob() throws Exception {
        ...
        CuratorFramework client = threadLocalClient.getCuratorClient().getCuratorClient();
        ConcurrentHashSet<EjobServerInfo> availableIps =  com.huangyiming.disjob.slaver.utils.SlaveUtils.refreshSlaveIp(client);
