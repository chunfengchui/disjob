...
public class HURL implements Serializable{
     ...
     * RPC的url转化为HURL对象
     *
     * @param url:类似于：ejob://192.168.196.1:9501/vipJobAppFour?serverGroup=vip&phpFilePath=''&className=com.huangyiming.ejob.java.app.VipJobAppFour&methodName=execute&version=1
     * @return
     */
