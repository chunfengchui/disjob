package com.huangyiming.ejob.java.app;
...
public class ProduceJobTest {
	...
	public static void main(String[] args) {
		String srcPath = "E:/workspace/disjob/EjobJavaApp/src/main/java/com/huangyiming/one/hundred/FireNowJobTemp.java"; 
		String targetPath = "E:/workspace/disjob/EjobJavaApp/src/main/java/com/huangyiming/one/hundred/FireNowJob_%s.java";
